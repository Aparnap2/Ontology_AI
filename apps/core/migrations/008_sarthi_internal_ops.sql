...
COMMENT ON TABLE finance_ops IS 'OntologyAI v4.2 Internal Ops — Finance Desk (AR/AP, payroll)';
COMMENT ON TABLE people_ops IS 'OntologyAI v4.2 Internal Ops — People Desk (HR, onboarding)';
COMMENT ON TABLE legal_ops IS 'OntologyAI v4.2 Internal Ops — Legal Desk (contracts, compliance)';
COMMENT ON TABLE it_assets IS 'OntologyAI v4.2 Internal Ops — IT & Tools Desk (SaaS, cloud)';
COMMENT ON TABLE admin_events IS 'OntologyAI v4.2 Internal Ops — Admin Desk (meetings, SOPs)';
