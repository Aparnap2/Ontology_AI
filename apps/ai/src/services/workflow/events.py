...
MEMORY_QUERY_TOPIC = "ontology_ai.memory.query"
MEMORY_STORE_TOPIC = "ontology_ai.memory.store"
MEMORY_RETRIEVE_TOPIC = "ontology_ai.memory.retrieve"
MEMORY_COMPRESS_TOPIC = "ontology_ai.memory.compress"
MEMORY_DECAY_TOPIC = "ontology_ai.memory.decay"

# Decision engine topics
DECISION_REQUEST_TOPIC = "ontology_ai.decision.request"
DECISION_RESULT_TOPIC = "ontology_ai.decision.result"

# Agent-to-agent topics
AGENT_EVENT_TOPIC = "ontology_ai.agent.events"
WORKFLOW_COMPLETE_TOPIC = "ontology_ai.workflow.complete"
WORKFLOW_FAILED_TOPIC = "ontology_ai.workflow.failed"
