...
Delivers decision results from ontology_ai.decision.results topic to
...
CONSUMER_GROUP = "ontology_ai-delivery-service"
DECISION_TOPIC = "ontology_ai.decision.results"
DELIVERY_STATUS_TOPIC = "ontology_ai.delivery.status"
...
class DeliveryService:
    ...
    Flow:
    1. Subscribe to ontology_ai.decision.results Redpanda topic
