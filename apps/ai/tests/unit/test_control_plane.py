...
class TestAgentRegistrationSchema:
    def test_valid_registration(self):
        ...
        assert a.agent_name == "Sarthi · Finance"
...
class TestAuditEventSchema:
    def test_audit_event_creation(self):
        ...
        assert e.agent_name == "Sarthi · Finance"
...
class TestControlPlaneRegistry:
    ...
    def test_agent_must_register_with_control_plane(self):
        ...
        assert registry.is_registered("Sarthi · Finance") is True
        assert registry.is_registered("GhostAgent") is False
        assert registry.is_action_allowed("Sarthi · Finance", "pause_failed_payment_retry") is True
        assert registry.is_action_allowed("Sarthi · Finance", "draft_investor_update") is False
