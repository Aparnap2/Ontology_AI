...
class TestSelfGuardianAlertSchema:
    def test_valid_alert(self):
        ...
        assert alert.observation.agent_name == "FP&A"
...
class TestSelfGuardianReportSchema:
    def test_valid_report(self):
        ...
        assert report.agent_summaries["FP&A"]["deviations"] == 1
...
class TestSelfGuardianDetector:
    def test_unauthorized_tool_detected(self):
        ...
        now = datetime.now()
        # "FP&A" only has "pause_failed_payment_retry"
        obs = AgentObservation(
            agent_name="FP&A",
            action="execute_tool",
    ...
    def test_generate_report_with_observations(self):
        ...
        assert report.agent_summaries["FP&A"]["deviations"] == 1
        assert report.agent_summaries["Reliability & Delivery"]["total"] == 1
        assert report.agent_summaries["Reliability & Delivery"]["deviations"] == 1
